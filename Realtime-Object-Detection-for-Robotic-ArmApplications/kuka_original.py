...
class Kuka:
  ...
  def applyAction(self, motorCommands):
    ...
    if (self.useInverseKinematics):
      ...
      #if (self.endEffectorPos[1] < -0.37):
        #self.endEffectorPos[1] = -0.37
      #if (self.endEffectorPos[1] > 0.42):
          #self.endEffectorPos[1] = 0.42
        
      self.endEffectorPos[0] = self.endEffectorPos[0] + dx
      #if (self.endEffectorPos[0] > 0.75):#0.65 #0.75
        #self.endEffectorPos[0] = 0.75
      if (self.endEffectorPos[0] > 0.75):#0.65 #0.75
        self.endEffectorPos[0] = 0.75
      #if (self.endEffectorPos[0] < 0.20):#0.50
        #self.endEffectorPos[0] = 0.20
      if (self.endEffectorPos[0] < 0.30):
        self.endEffectorPos[0] = 0.30
      self.endEffectorPos[1] = self.endEffectorPos[1] + dy
      if (self.endEffectorPos[1] < -0.27):
        self.endEffectorPos[1] = -0.27
      #if (self.endEffectorPos[1] < -0.30):#-0.17
        #self.endEffectorPos[1] = -0.30
      if (self.endEffectorPos[1] > 0.32):
        self.endEffectorPos[1] = 0.32
      #if (self.endEffectorPos[1] > 0.35):#0.22
        #self.endEffectorPos[1] = 0.35
      ...
      if (self.endEffectorPos[2] < 0.31):
        self.endEffectorPos[2] = 0.31
